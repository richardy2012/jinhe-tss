 ...
 * 从MySQL数据里同步用户组织信息
 */
public class MySQLDataDao extends BaseDBDataDao{
    ...
    protected Connection getConnection(Map<String, String> map){
        ...
        try {
            ...
            throw new BusinessException("连接外部MySQL数据库失败,请检查连接参数", e);
        } catch (ClassNotFoundException e) {
            throw new BusinessException("连接外部MySQL数据库失败,驱动程序找不到", e);
        }
        return conn;
    }
}