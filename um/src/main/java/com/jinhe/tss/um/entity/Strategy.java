 ...
 */
@Entity
@Table(name = "um_Strategy")
@SequenceGenerator(name = "Strategy_sequence", sequenceName = "Strategy_sequence", initialValue = 1000, allocationSize = 10)
public class Strategy extends OperateInfo implements IEntity, ITreeNode, IXForm {

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "Strategy_sequence")
