...
public class CMSCommonOperation4TestSupport extends TxSupportTest4CMS {
    
    protected ChannelAction channelAction;
    protected ArticleAction articleAction;
    ...
    public void setUp() throws Exception {
        ...
        channelAction = new ChannelAction();
        channelAction.setChannelService(channelService);
        channelAction.setPublishManger(publishManger);
        
        articleAction = new ArticleAction();
        articleAction.setService(articleService);
    }
    ...
    protected Article createArticle(Channel channel, Long tempArticleId) {
        Article article = articleAction.getArticle();
        ...
        articleAction.setArticleContent(" 最近几年以来，社会矛盾逐渐成为了中国公众瞩目的焦点---" +
        ...
        articleAction.setChannelId(channel.getId());
        articleAction.setArticleId(tempArticleId);
        articleAction.setAttachList("1,2");
