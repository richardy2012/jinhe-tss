...
public class CMSConstants {
    ...
    /** 根结点ID */
    public static final Long HEAD_NODE_ID = -1L; 
    
    public static final Long DEFAULT_NEW_ID = -10L;
    
    public static final String COPY_NAME_PREFIX = "副本_";   // 副本前缀
    
    public static final Integer DEFAULT_HIT_COUNT = 0;	//默认点击率
    
    /* 文章附件 */
    public static final Integer ATTACHMENTTYPE_PICTURE = 1;	// 文章附件图片类型
    public static final Integer ATTACHMENTTYPE_OFFICE  = 2;	// 文章附件OFFICE类型

    /* 文章状态 */
    public static final Integer LOCKING_STATUS   = 0; // locked
    public static final Integer START_STATUS     = 1; // 编辑中
    public static final Integer TOPUBLISH_STATUS = 2; // 待发布
    public static final Integer XML_STATUS       = 3; // 已发布生成xml文件
    public static final Integer OVER_STATUS      = 4; // 过期状态
   
    /* 策略类型常量 */
    public static final Integer TACTIC_TIME_TYPE    = 0; // 时间策略
    public static final Integer TACTIC_INDEX_TYPE   = 1; // 索引策略
    public static final Integer TACTIC_PUBLISH_TYPE = 2; // 发布策略
    public static final Integer TACTIC_EXPIRE_TYPE  = 3; // 文章过期策略
