...
values (-2, 'tss', 'Main-Group',     0, 1,  0, 1, 1, '00001', 0);

insert into um_group (ID, APPLICATIONID, NAME, DISABLED, GROUPTYPE, PARENTID, SEQNO, LEVELNO, DECODE, lockVersion)
values (-3, 'tss', 'Assistant-Group',   0, 2,  0, 2, 1, '00002', 0);

insert into um_group (ID, APPLICATIONID, NAME, DISABLED, GROUPTYPE, PARENTID, SEQNO, LEVELNO, DECODE, lockVersion)
values (-4, 'tss', 'Other-Group',   0, 3,  0, 3, 1, '00003', 0);

insert into um_group (ID, APPLICATIONID, NAME, DISABLED, GROUPTYPE, PARENTID, SEQNO, LEVELNO, DECODE, lockVersion)
values (-7, 'tss', 'Self-Register-Group', 0, 1, -2, 1, 2, '0000100001', 0);

insert into um_group (ID, APPLICATIONID, NAME, DISABLED, GROUPTYPE, PARENTID, SEQNO, LEVELNO, DECODE, lockVersion)
values (-8, 'tss', 'Auth-Group', 0, 1, -7, 1, 3, '000010000100001', 0);

insert into um_group (ID, APPLICATIONID, NAME, DISABLED, GROUPTYPE, PARENTID, SEQNO, LEVELNO, DECODE, lockVersion)
values (-9, 'tss', 'Un-Auth-Group', 0, 1, -7, 2, 3, '000010000100002', 0);
