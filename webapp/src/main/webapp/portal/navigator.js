   ...
   //     initUserInfo();
    ...
    function loadToolBar(_operation){
        ...
        if(null==xmlIsland){//还没有就创建
            ...
            //菜单管理
            str[str.length] = "    <button id=\"b1\" code=\"2\" icon=\"" + ICON + "view.gif\" label=\"查看\" cmd=\"editTreeNode(false)\" enable=\"'0'!=getTreeNodeType()\"/>";
            str[str.length] = "    <button id=\"b2\" code=\"2\" icon=\"" + ICON + "edit.gif\" label=\"编辑\" cmd=\"editTreeNode()\" enable=\"'0'!=getTreeNodeType()\"/>";
            str[str.length] = "    <button id=\"b3\" code=\"2\" icon=\"" + ICON + "del.gif\" label=\"删除\" cmd=\"delTreeNode()\" enable=\"'0'!=getTreeNodeType()\"/>";
            str[str.length] = "    <button id=\"b5\" code=\"2\" icon=\"" + ICON + "move.gif\" label=\"移动到...\" cmd=\"moveMenuItemTo()\" enable=\"'0'!=getTreeNodeType() &amp;&amp; '1'!=getTreeNodeType()\"/>";
            str[str.length] = "    <button id=\"b6\" code=\"2\" icon=\"" + ICON + "new_menu.gif\" label=\"新建菜单\" cmd=\"addNewMenu()\" enable=\"'0'==getTreeNodeType()\"/>";
            str[str.length] = "</toolbar>";
