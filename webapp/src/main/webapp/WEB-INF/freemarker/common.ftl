...
<#macro getArticleListXML channelId, page=1, pagesize=5>
	<#assign data = articleService.getArticleListXMLByChannel(channelId, page, pagesize) />
	<#assign doc  = manager.translateValue(data)/>
...
<#macro getPicArticleListByChannel channelId, page=1, pagesize=5>
	<#assign data = articleService.getPicArticleListByChannel(channelId, page, pagesize) />
	<#assign doc  = manager.translateValue(data) />
	<#assign articleList = doc.Response.ArticleList.rss/>
        <#assign channelName = articleList.channelName?default('')/>
	<#assign totalPageNum = articleList.totalPageNum/>
...
<#macro search channelId, searchStr, page=1, pagesize=5>
	<#assign data = articleService.search(tacticId, searchStr, page, pagesize) />
	<#assign doc  = manager.translateValue(data)/>
	<#assign articleList = doc.Response.ArticleList.rss/>
	<#assign totalPageNum = articleList.totalPageNum/>
	<#assign totalRows = articleList.totalRows/>
